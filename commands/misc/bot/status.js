    ...
    osu.cpuUsage(async usage => {
        ...
        const embed = new EmbedBuilder()
            ...
            .addFields(
                ...
                { name: '参加ボイスチャンネル数', value: `\`${globalThis.voice_channel.length}\`チャンネル`, inline: true },
                { name: '視聴Twitch数', value: `\`${globalThis.tlivechat.length}\`チャンネル`, inline: true },
                { name: '視聴Youtube数', value: `\`${globalThis.ylivechat.length}\`チャンネル`, inline: true },
